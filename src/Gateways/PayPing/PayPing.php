...
namespace Salamzadeh\PBPayment\Gateways\PayPing;
...
class PayPing extends AbstractGateway implements GatewayInterface
{
    ...
    public function initialize(array $parameters = []): self
	{
        ...
        $this->setToken($parameters['token'] ?? app('config')->get('pbpayment.payping.merchant-id'));

        $this->setAddFees($parameters['add_fees'] ?? app('config')->get('pbpayment.payping.add_fees', false));
        ...
        $this->setCallbackUrl($parameters['callback_url']
            ?? app('config')->get('pbpayment.payping.callback-url')
    ...
    protected function purchaseViewParams(): array
    {
        return [
            'title' => 'پی‌پینگ',
            'image' => 'https://raw.githubusercontent.com/salamzadeh/pb-payment/master/resources/assets/img/payping.png',
        ];
    }
