...
namespace Salamzadeh\PBPayment\Gateways\PayIr;
...
class PayIr extends AbstractGateway implements GatewayInterface
{
    ...
    public function initialize(array $parameters = []): self
    {
        ...
        $this->setApi($parameters['api'] ?? app('config')->get('pbpayment.payir.merchant-id'));

        $this->setCallbackUrl($parameters['callback_url']
            ?? app('config')->get('pbpayment.payir.callback-url')
    ...
    protected function purchaseViewParams(): array
    {
        return [
            'title' => 'پی',
            'image' => 'https://raw.githubusercontent.com/salamzadeh/pb-payment/master/resources/assets/img/pay.png',
        ];
    }
