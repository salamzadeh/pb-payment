...
namespace Salamzadeh\PBPayment\Models;

use Illuminate\Database\Eloquent\Model;

use Salamzadeh\PBPayment\Traits\PBPaymentDatabase as DatabaseTrait;

/**
 * An Eloquent Model: 'PBPaymentTransaction'
 *
 * @property integer $id
 ...
 */
class PBPaymentTransaction extends Model
{
    use DatabaseTrait;
